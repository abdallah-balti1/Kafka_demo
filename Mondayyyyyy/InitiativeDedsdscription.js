          ...
          <div>
            <CommonStyle.ContentContainer>
              ...
              <CommonStyle.ColumnContainer>
                ...
                {/* Committee Date principal (toujours affiché) */}
                <CommonStyle.RowContainer>
                  <CommonStyle.Label>
              ...
              <CommonStyle.ColumnContainer>
                ...
                {/* ✅ Template — ligne 5, aligné avec Committee Date colonne 1 */}
                <CommonStyle.RowContainer>
              ...
              <CommonStyle.ColumnContainer>
                ...
                {/* ✅ Pre Committee Date 1 — colonne 3, ligne 5 */}
                {values.commiteeNames.length > 1 && (
                  <CommonStyle.RowContainer>
                    <CommonStyle.Label>
                      {values.commiteeNames[0] + ' Committee Date'}
                    </CommonStyle.Label>
                    {isEditing ? (
                      <Field
                ...
                {/* ✅ Pre Committee Date 2 — colonne 3, ligne 6 */}
                {values.commiteeNames.length > 2 && (
                  <CommonStyle.RowContainer>
                    <CommonStyle.Label>
                      {values.commiteeNames[1] + ' Committee Date'}
                    </CommonStyle.Label>
                    {isEditing ? (
                      <Field
