...
export default function GovernanceConfig({
  ...
  return (
    <Style.Container>
      {/* ── Error modal — governance linked to initiatives ── */}
      {deleteLinkedError && (
        <Style.ErrorOverlay>
          <Style.ErrorModal>
            <Style.ErrorIconWrapper>
              <WarningIcon />
            </Style.ErrorIconWrapper>
            <Style.ErrorTitle>Cannot delete governance</Style.ErrorTitle>
            <Style.ErrorBody>
              {deleteLinkedError.message}
            </Style.ErrorBody>
            <Style.ErrorHint>
              Please unlink or reassign all initiatives before deleting this governance.
            </Style.ErrorHint>
            <Style.ErrorCloseBtn type="button" onClick={clearGovernanceError}>
              Got it
            </Style.ErrorCloseBtn>
          </Style.ErrorModal>
        </Style.ErrorOverlay>
