...
import {
  ...
  UPDATE_GOVERNANCE,
  UPDATE_GOVERNANCE_SUCCESS,
  UPDATE_GOVERNANCE_FAILURE,
  CREATE_COMMITEE,
  ...
  UPDATE_COMMITEE,
  UPDATE_COMMITEE_SUCCESS,
  UPDATE_COMMITEE_FAILURE,
  ...
  UPDATE_STATUS_INITIATIVE_SUCCESS,
  UPDATE_STATUS_INITIATIVE_FAILURE,
} from './constants';
...
export const updateGovernance = (id: any, payload: any) => ({
  type: UPDATE_GOVERNANCE,
  payload: { id, payload },
});

export const updateGovernanceSuccess = (data: any) => ({
  type: UPDATE_GOVERNANCE_SUCCESS,
  payload: data,
});

export const updateGovernanceFailure = (error: any) => ({
  type: UPDATE_GOVERNANCE_FAILURE,
  payload: error,
});

// — Commitee ——————————————————————————————————————————————————

export const createCommitee = (payload: {
...
export const updateCommitee = (id: any, payload: any) => ({
  type: UPDATE_COMMITEE,
  payload: { id, payload },
});

export const updateCommiteeSuccess = (data: any) => ({
  type: UPDATE_COMMITEE_SUCCESS,
  payload: data,
});

export const updateCommiteeFailure = (error: any) => ({
  type: UPDATE_COMMITEE_FAILURE,
  payload: error,
});

// — StatusInitiative ——————————————————————————————————————————

export const createStatusInitiative = (payload: {
  commitee_id: number,
  name: string,
...
export const updateStatusInitiative = (id: any, payload: any) => ({
  type: UPDATE_STATUS_INITIATIVE,
  payload: { id, payload },
});

export const updateStatusInitiativeSuccess = (data: any) => ({
  type: UPDATE_STATUS_INITIATIVE_SUCCESS,
  payload: data,
});

export const updateStatusInitiativeFailure = (error: any) => ({
  type: UPDATE_STATUS_INITIATIVE_FAILURE,
  payload: error,
});
