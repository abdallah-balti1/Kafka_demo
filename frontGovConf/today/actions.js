...
export const deleteCommiteeLinkedError = (payload: { message: string, initiative_count: number }) => ({
  type: DELETE_COMMITEE_LINKED_ERROR,
  payload,
});
...
export const deleteStatusLinkedError = (payload: { message: string, initiative_count: number }) => ({
  type: DELETE_STATUS_LINKED_ERROR,
  payload,
});
