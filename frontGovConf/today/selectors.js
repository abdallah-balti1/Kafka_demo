...
export const selectCommiteeDeleteLinkedError = (state: any) =>
  state.entities.governance.deleteCommiteeLinkedError || null;

export const selectStatusDeleteLinkedError = (state: any) =>
  state.entities.governance.deleteStatusLinkedError || null;
