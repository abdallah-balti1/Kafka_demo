...
from routes.governance import (
    ...
    INITIATIVE_COMMITEE_DATE_BLUEPRINT,
    INITIATIVE_COMMITEE_DATES_BLUEPRINT,
...
app.register_blueprint(INITIATIVE_COMMITEE_DATES_BLUEPRINT)
app.register_blueprint(INITIATIVE_COMMITEE_DATE_BLUEPRINT)
